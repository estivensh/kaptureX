...
enum class Flash(
    ...
    Off(Res.drawable.flash_off, Res.string.flash_off), On(
        Res.drawable.flash_on,
        Res.string.flash_on
    ),
    Auto(Res.drawable.flash_auto, Res.string.flash_auto), Always(
        Res.drawable.flash_always,
        Res.string.flash_always
    );
